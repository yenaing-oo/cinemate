...
import { PaymentSecurityNote } from "~/components/checkout/payment-security-note";
import {
    formatCardNumber,
    formatExpiry,
    getCardBrand,
...
export function PaymentDetailsForm({
    ...
    const [touchedFields, setTouchedFields] = useState<
        Partial<Record<"cardholderName" | "cardNumber" | "expiry" | "cvv", boolean>>
    >({});
    ...
    }, [cardBrand, cardDigits, cardholderName, errors, expiry, onValidPaymentChange]);

    const showError = (field: "cardholderName" | "cardNumber" | "expiry" | "cvv") =>
        touchedFields[field] ? errors[field] : undefined;

    const markTouched = (field: "cardholderName" | "cardNumber" | "expiry" | "cvv") => {
                        ...
                        onChange={(e) => {
                            setCvv(
                                e.target.value
                                    ...
                                    .slice(
                                        0,
                                        cardBrand === "American Express" ? 4 : 3
                                    )
                            );
                            markTouched("cvv");
                        }}
