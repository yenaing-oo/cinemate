                        ...
                        <div className="space-y-5">
                            ...
                            <div className="rounded-2xl border border-cyan-300/15 bg-cyan-300/8 p-4">
                                ...
                                <p className="text-muted-foreground mt-2 text-sm leading-6">
                                    Enter the invitation code to open the
                                    matching party and review the details shared
                                    with your group.
                                </p>
                            </div>
                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                <div className="rounded-2xl border border-white/10 bg-white/4 p-4">
                                    ...
                                    <p className="text-muted-foreground mt-1 text-sm leading-6">
                                        ...
                                        and stay aligned with everyone
                                        attending.
                                    </p>
                                </div>
                                ...
                                <div className="rounded-2xl border border-white/10 bg-white/4 p-4">
                                    ...
                                    <p className="text-muted-foreground mt-1 text-sm leading-6">
                                        Check the party details, confirm the
                                        plan, and get ready for the next booking
                                        step.
                                    </p>
                                </div>
                            </div>
